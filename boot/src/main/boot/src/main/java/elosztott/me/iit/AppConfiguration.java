...
public class AppConfiguration extends WebMvcConfigurerAdapter {
	...
	private void initOutputFiles() {
		   try{File fileStarter = new File("StarterCourses.txt");
			 BufferedWriter outputStarter = new BufferedWriter(new FileWriter(fileStarter));
			outputStarter.write("");
			outputStarter.close();
			 File fileNotStarter = new File("NotStarterCourses.txt");
			 BufferedWriter outputNotStarter = new BufferedWriter(new FileWriter(fileNotStarter));
			 outputNotStarter.write("");
	 ...
	 @Bean  
	   ...
	   @Bean
	    ...
	    public MessageSource messageSource() {
	        ...
	        messageSource.setBasename("/languages/language");
